...
import { mungeNames, mungeCaptured, mungeEncountered, mungeData } from './mung-utils.js';
import massArray from '../data/pokemon.js';
/*eslint-disable*/
const deckPics = document.querySelector('header');

const pokeImg1 = deckPics.children[0];
const pokeId1 = deckPics.children[1];
const pokeImg2 = deckPics.children[2];
const pokeId2 = deckPics.children[3];
const pokeImg3 = deckPics.children[4];
const pokeId3 = deckPics.children[5];
const pokeImg4 = deckPics.children[6];
const pokeId4 = deckPics.children[7];
const pokeImg5 = deckPics.children[8];
const pokeId5 = deckPics.children[9];
const pokeImg6 = deckPics.children[10];
const pokeId6 = deckPics.children[11];
const pokeImg7 = deckPics.children[12];
const pokeId7 = deckPics.children[13];
const pokeImg8 = deckPics.children[14];
const pokeId8 = deckPics.children[15];
const pokeImg9 = deckPics.children[16];
const pokeId9 = deckPics.children[17];
const pokeImg10 = deckPics.children[18];
const pokeId10 = deckPics.children[19];

//const pokeImg1 = pokeId1.children[0];
...
const type2 = mungeData(massArray, 'type_2');
const type1 = mungeData(massArray, 'type_1');
const attack = mungeData(massArray, 'attack');
const images = mungeData(massArray, 'url_image');
const hp = mungeData(massArray, 'hp');

pokeImg1.src = images[0];
pokeImg2.src = images[1];
pokeImg3.src = images[2];
pokeImg4.src = images[3];
pokeImg5.src = images[4];
pokeImg6.src = images[5];
pokeImg7.src = images[6];
pokeImg8.src = images[7];
pokeImg9.src = images[8];
pokeImg10.src = images[9];
