...
const pokeId2 = deckPics.children[1];
const pokeId3 = deckPics.children[2];
const pokeId4 = deckPics.children[3];
const pokeId5 = deckPics.children[4];
const pokeId6 = deckPics.children[5];
const pokeId7 = deckPics.children[6];
const pokeId8 = deckPics.children[7];
const pokeId9 = deckPics.children[8];
const pokeId10 = deckPics.children[9];
